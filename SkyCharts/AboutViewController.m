...
- (void)viewDidLoad {
    ...
    NSString *publicVersion=[[NSBundle mainBundle]objectForInfoDictionaryKey:@"SkyChartsPublicVersion"];
    if (![publicVersion length]) publicVersion=[[NSBundle mainBundle]objectForInfoDictionaryKey:@"CFBundleShortVersionString"]?:@"";
    NSString *build=[[NSBundle mainBundle]objectForInfoDictionaryKey:@"CFBundleVersion"]?:@"";
    UILabel *details=[self label:CGRectMake(38,232,self.view.bounds.size.width-76,180) text:[NSString stringWithFormat:@"Offline aviation charts and airport maps\nfor legacy iPad\n\n%@ (Build %@)\n\nDeveloped by Sky Ning\n© 2026 Sky Ning. All rights reserved.",publicVersion,build] font:[UIFont systemFontOfSize:17] color:[UIColor colorWithWhite:.20 alpha:1]];details.numberOfLines=0;details.autoresizingMask=UIViewAutoresizingFlexibleWidth;[self.view addSubview:details];
